    ...
    <div className="bg-zinc-950 text-zinc-50 min-h-screen font-sans overflow-x-hidden selection:bg-indigo-550 selection:text-white">
      ...
      <section className="max-w-4xl mx-auto px-8 pt-20 pb-16 text-center space-y-6">
        ...
        <div className="pt-4 flex justify-center gap-4">
          ...
          <a
            href="#features"
            className="inline-flex items-center px-5 py-2.5 bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 text-zinc-400 hover:text-zinc-200 rounded-lg text-xs font-semibold tracking-wide transition-all"
          >
            Learn More
          </a>
        </div>
